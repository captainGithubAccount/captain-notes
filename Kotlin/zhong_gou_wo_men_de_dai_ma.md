...
之前说过，我们使用id来访问views。所以我要修改`RecyclerView`的id，<font color = "red">不使用下划线，让它更加适合Kotlin变量的名字。</font>XML最后如下：
...
```
之前的代码参考[使Forecast list可点击（init{}、invoke、.with()）](shi_forecast_list_ke_dian_ji.md)
