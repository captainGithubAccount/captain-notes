...
这是非常棒的简化！当我们定义了一个方法，我们必须使用大括号包围，然后在箭头的左边指定参数，在箭头的右边返回函数执行的结果。<font color = "red" size = 5>如果左边的参数没有使用到，我们甚至可以省略左边的参数：</font>

```kotlin
view.setOnClickListener({ toast("Click") })
```

<font color = "red" size = 5>如果这个函数的最后一个参数是一个函数，我们可以把这个函数移动到圆括号外面：</font>
